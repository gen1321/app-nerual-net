/* shoutouts to  Eric Weinstein */
/* https://github.com/ericqweinstein/ruby-mnist/blob/master/app/components/EditableCanvas.js*/
...
class EditableCanvas extends Component {
  ...
  draw() {
    ...
    /* this.setState( { ctx: { strokeStyle: this.state.x } });*/
    /* this.setState( { ctx: { lineWidth: this.state.y } });*/
